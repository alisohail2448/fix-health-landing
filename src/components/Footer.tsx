    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          ...
          <img src="https://ik.imagekit.io/tcfp7i31d/logo_with_yp_black_urUeyjKwY.svg" width={200} alt="" />
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@fixhealth.com">support@fixhealth.com</a>
            </li>
            <li>
              <a href="mailto:appointment@fixhealth.com">
                appointment@fixhealth.com
              </a>
            </li>
            <li>
